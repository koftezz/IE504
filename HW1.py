...
file = r'C:/Users/batuhan.organ/Desktop/IEOzU/IE504/IE504/Data/Q1_Data.txt'
...
def Nearest_neighbor_search(demand, dist_matrix):
    ...
    while Control2:
        ...
        while Control:
            ...
            if (total_distance + nearest_node_distance + dist_matrix[nearest_node, 0] < 500) and (
...
print("vehicle number: ", len(Result_list))
        ...
        for j in range(1, len(Result_list[i]) - 2):
            ...
            for k in range(j + 1, len(Result_list[i]) - 1):
                ...
                saving = (dist_matrix[Result_list[i][j - 1], vehicle_2] + dist_matrix[vehicle_2, Result_list[i][j + 1]]
                          + dist_matrix[Result_list[i][k - 1], vehicle_1] + dist_matrix[
                              vehicle_1, Result_list[i][k + 1]]) - \
                         (dist_matrix[Result_list[i][j - 1], vehicle_1] + dist_matrix[vehicle_1, Result_list[i][j + 1]] \
                          + dist_matrix[Result_list[i][k - 1], vehicle_2] + dist_matrix[
                              vehicle_2, Result_list[i][k + 1]])
